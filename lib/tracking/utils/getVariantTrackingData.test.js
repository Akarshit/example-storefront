...
const variant = {
  _id: "moc/catalogProductItem:1002",
  variantId: "1002",
  ...
  options: [
    {
      _id: "moc/catalogProductItem:1003",
      variantId: "1003",
...
test("getVariantTrackingData should return variant tracking data with supplied variant", () => {
  ...
  const result = {
    variant: "moc/catalogProductItem:1002",
    price: undefined,
    quantity: 1,
    position: 0,
    value: undefined,
...
test("getVariantTrackingData should return variant tracking data with supplied variant and product", () => {
  ...
  const result = {
    ...
    url: "/product/my-product/moc%2FcatalogProductItem%3A1002"
  };
...
test("getVariantTrackingData should return variant tracking data with supplied variant, optionId and product", () => {
  const data = getVariantTrackingData({ variant, optionId: "moc/catalogProductItem:1003", product });

  const result = {
    variant: "moc/catalogProductItem:1003",
    price: 29.99,
    quantity: 1,
    position: 0,
    value: 29.99,
    image_url: "/assets/image-1003.jpg", // eslint-disable-line camelcase
    url: "/product/my-product/moc%2FcatalogProductItem%3A1003"
  };
...
test("getVariantTrackingData should not have media", () => {
  ...
  const data = getVariantTrackingData({
    variant,
    optionId: "moc/catalogProductItem:1003",
