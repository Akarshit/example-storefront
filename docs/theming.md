...
Variables for customizing the theme are located in the `[src/lib/theme/mocTheme.js](https://github.com/mailchimp-open-commerce/example-storefront/blob/master/src/lib/theme/mocTheme.js)  file. The [Material UI theme guide](https://material-ui.com/customization/themes/) has additional details on how to customize the theme.
...
Styles for components can be overridden globally from the [src/lib/theme/mocTheme.js](https://github.com/mailchimp-open-commerce/example-storefront/blob/master/src/lib/theme/mocTheme.js) file. **Before applying an override, consider updating the theme variables as it may provide you with better results.**
